...
namespace ITS.CompanyBookSystem.Business.Implement
{
    ...
    /// 业务逻辑层实现基类
    /// </summary>
    /// <typeparam name="TInterface">数据访问层接口</typeparam>
    /// <typeparam name="TEntity">数据实体类型</typeparam>
    public abstract class BookSystemBaseEntityLogic<TInterface, TEntity> : EntityBaseLogic<TEntity>
        ...
        where TEntity : class,global::ITS.CompanyBookSystem.DataAccess.Entity.IEntityBaseExtention
    {
        ...
        /// 数据访问层实例
        /// </summary>
        protected TInterface Repository { set; get; }
        ...
        public BookSystemBaseEntityLogic(TInterface repository)
            : base(repository)
        {
        ...
        /// <param name="status">操作状态</param>
        public override void Update(TEntity entity, out OperateStatus status)
        {
            entity.State = (int)StateSign.Normal;
